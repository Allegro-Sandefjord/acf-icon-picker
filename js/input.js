(function($){
	...
	function initialize_field( $el ) {
		...
		$el.find('.acf-icon-picker-field').each(function() {
			...
			$(document).on('click', '.acf-icon-picker .acf-button-delete', function(){
	...
	if( typeof acf.add_action !== 'undefined' ) {
		...
		*/
		...
		acf.add_action('ready append', function( $el ){
			...
			// search $el for fields of type 'icon-picker'
			acf.get_fields({ type : 'icon-picker'}, $el).each(function(){
		...
		*/
		...
		$(document).on('acf/setup_fields', function(e, postbox){
			...
			$(postbox).find('.field[data-field_type="icon-picker"]').each(function(){
			...
			if(typeof postbox.selector == 'undefined') {
				...
				$(postbox).find('.acf-icon-picker .inner').empty();
